...
ALLOWED_HOSTS = ['www.nffb.cz', 'nffb.cz', '127.0.0.1']

ADMINS = [
    ('Jakub Dorňák', 'jakub.dornak@nffb.cz'),
]
MANAGERS = [
    ('Jakub Dorňák', 'jakub.dornak@nffb.cz'),
    ('Hana Sobotková', 'hana.sobotkova@nffb.cz'),
]
SERVER_EMAIL = '"Nadační fond Františka Buriana" <no-reply@nffb.cz>'
...
WSGI_APPLICATION = 'nffb.wsgi.application'
